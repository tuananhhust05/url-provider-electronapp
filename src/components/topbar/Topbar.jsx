      ...
      {/*Form tạo nhóm*/}
      {
        ...
        ( <form>
            <div style={{position:"fixed",top:"20%",backgroundColor:"white",height:"400px", width:"400px",boxShadow:"2px 2px 2px black",borderRadius:"10px"}}>
                <i onClick={() =>setOpenCreateGroup(false)} style={{position:"absolute",right:"5px",top:"7px"}}class="fa-solid fa-xmark"></i>
                ...
                <button onClick={() =>handleSubmit()} class="btn btn-primary" style={{position:"absolute",bottom:"5px",margin:"0 30%"}}>
                  Tạo nhóm
                </button>
            </div>
          </form>
